...
if __name__=="__main__":
    ...
    print(json.dumps(read_excel_data,indent=1,ensure_ascii=False))
    print(read_excel_data['test_login_success']['test_parameter']['username'])
    test_name=read_excel_data['test_login_success']
    print(test_name['excepted_result'])